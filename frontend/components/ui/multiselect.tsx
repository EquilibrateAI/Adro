...
// Converts a flat list of options into a grouped object based on a specific key
...
// Filters out already selected options from the available list to prevent duplicates
...
// Helper to check if a set of options exists within the grouped options structure
...
// A complex multi-select component with support for searching, grouping, and async loading
...
>(
  (
    ...
    // Closes the dropdown when a click is detected outside the component boundaries
